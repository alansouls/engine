...
namespace SSGE
{
    ...
    QuadRendererComponent::QuadRendererComponent(GameObject* gameObject)
        : RendererComponent(gameObject, createItem(), TypeName), m_topLeft(1.0f, 1.0f), m_width(100.0f),
          m_height(100.0f),
    ...
    auto QuadRendererComponent::bindFields() -> void
    {
        ...
        m_fields.push_back(
            std::make_unique<ComponentField>("Width", "100.0", ComponentField::FieldType::Float, &m_width));
        m_fields.push_back(
