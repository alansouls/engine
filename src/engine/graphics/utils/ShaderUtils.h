...
private:
	...
	static inline const char* compiledShaderPath = "./engine/graphics/drivers/shaders/compiled/";
	static inline const char* shaderPath = "./engine/graphics/drivers/shaders/";
};
