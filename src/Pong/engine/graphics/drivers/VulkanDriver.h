...
public:
  VulkanDriver(const std::vector<const char *> requiredExtensions,
  ...
  void
  drawFrame(const std::vector<GraphicsOperation *> &updateOperations) override;
...
private:
  ...
  getCircleVertexAttributeDescriptions() {
